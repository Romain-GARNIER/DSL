...
public class ArduinoMLAdapterFactory extends AdapterFactoryImpl {
	...
	protected ArduinoMLSwitch<Adapter> modelSwitch =
		new ArduinoMLSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSinkError(SinkError object) {
				return createSinkErrorAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link arduinoML.BaseCondition <em>Base Condition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link arduinoML.BooleanCondition <em>Boolean Condition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link arduinoML.SinkError <em>Sink Error</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSinkErrorAdapter() {
		return null;
	}
