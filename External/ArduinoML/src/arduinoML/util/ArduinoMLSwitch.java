...
public class ArduinoMLSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArduinoMLPackage.BASE_CONDITION: {
				...
				if (result == null) result = caseCondition(baseCondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ArduinoMLPackage.SINK_ERROR: {
				SinkError sinkError = (SinkError)theEObject;
				T result = caseSinkError(sinkError);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sink Error</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sink Error</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSinkError(SinkError object) {
		return null;
	}
