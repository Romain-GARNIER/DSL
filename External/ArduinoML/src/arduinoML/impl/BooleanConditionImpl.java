 ...
 * </p>
 * <ul>
 *   <li>{@link arduinoML.impl.BooleanConditionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanConditionImpl extends ConditionImpl implements BooleanCondition {
	...
	protected EClass eStaticClass() {
		return ArduinoMLPackage.Literals.BOOLEAN_CONDITION;
	}
	...
	public void setOperator(Operator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoMLPackage.BOOLEAN_CONDITION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArduinoMLPackage.BOOLEAN_CONDITION__OPERATOR:
				return getOperator();
		}
