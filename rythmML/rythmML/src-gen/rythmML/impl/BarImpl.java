 ...
 *   <li>{@link rythmML.impl.BarImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BarImpl extends MinimalEObjectImpl.Container implements Bar {
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RythmMLPackage.BAR__ID, oldId, id));
	}
