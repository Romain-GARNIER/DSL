 ...
 *   <li>{@link rythmML.impl.BeatImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BeatImpl extends MinimalEObjectImpl.Container implements Beat {
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RythmMLPackage.BEAT__ID, oldId, id));
	}
